...
Proje prod'a en yakın halinde yani secretlerla oluşturulmuştur windowsda localde secretler stabil olarak desteklenmediği için environment variables ile değiştirebilirsiniz.Linuxta ise hiçbir sıkıntı yoktur.
