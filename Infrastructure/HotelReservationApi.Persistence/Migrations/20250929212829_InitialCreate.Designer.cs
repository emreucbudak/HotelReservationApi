...
namespace HotelReservationApi.Persistence.Migrations
{
    ...
    [Migration("20250929212829_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelReservationApi.Domain.Entities.RoomTypes", b =>
                {
                    ...
                    b.Property<int>("TypesFeaturesId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("TypesFeaturesId");
            ...
            modelBuilder.Entity("HotelReservationApi.Domain.Entities.Hotels", b =>
                {
                    ...
                    b.HasOne("HotelReservationApi.Domain.Entities.HotelInformation", "HotelInformation")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelReservationApi.Domain.Entities.RoomTypes", b =>
                {
                    b.HasOne("HotelReservationApi.Domain.Entities.TypesFeatures", "TypesFeatures")
                        .WithMany()
                        .HasForeignKey("TypesFeaturesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
