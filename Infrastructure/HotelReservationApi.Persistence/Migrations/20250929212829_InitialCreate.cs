        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypesFeaturesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomTypes_TypesFeatures_TypesFeaturesId",
                        column: x => x.TypesFeaturesId,
                        principalTable: "TypesFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelInformationId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Hotels_HotelInformations_HotelInformationId",
                        column: x => x.HotelInformationId,
                        principalTable: "HotelInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hotels_HotelInformationId",
                table: "Hotels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypes_TypesFeaturesId",
                table: "RoomTypes",
                column: "TypesFeaturesId");
        }
